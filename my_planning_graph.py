...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in actions:
            ...
            if node_action.prenodes.issubset(previous_s):
                for node_prev in previous_s:
                    
                    node_prev.children.add(node_action)
                    node_action.parents.add(node_prev)
