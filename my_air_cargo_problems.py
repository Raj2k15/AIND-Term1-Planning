...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            ...
            #get valid actions from all the possible actions which satisfy the problems postive and dissatisfy negative preconditon  
            ...
            if action_possible: possible_actions.append(action)
